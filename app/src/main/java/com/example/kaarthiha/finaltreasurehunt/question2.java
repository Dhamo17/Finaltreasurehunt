...
public class question2 extends AppCompatActivity {
    ...
    public double ll, ln;
    String question,quest3,quest4,quest5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question=getIntent().getExtras().getString("ques2");
        lat2=getIntent().getExtras().getDouble("lati2");
        lot2=getIntent().getExtras().getDouble("longi2");

        quest3=getIntent().getExtras().getString("ques3");
        lat3=getIntent().getExtras().getDouble("lati3");
        lot3=getIntent().getExtras().getDouble("longi3");

        quest4=getIntent().getExtras().getString("ques4");
        ...
        verify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!tv1.getText().toString().equals("") && !tv2.getText().toString().equals("") && !tv1.getText().toString().equals("Small Text") && !tv2.getText().toString().equals("Small Text")) {
                    ...
                    df = lt.ansloca(dd, ds, lat2, lot2);
                    Toast.makeText(getApplication(), "" + df, Toast.LENGTH_LONG).show();
                    if (df <= 20) {
                        MediaPlayer mp = MediaPlayer.create(question2.this, R.raw.correct);
                        mp.start();

                        TastyToast.makeText(question2.this, "correct", TastyToast.LENGTH_LONG, TastyToast.SUCCESS).show();

                        Intent i = new Intent(question2.this, question3.class);
                        i.putExtra("ques3", quest3);
                        i.putExtra("lati3", lat3);
                        i.putExtra("longi3", lot3);


                        i.putExtra("ques4", quest4);
                        ...
                        MediaPlayer mp = MediaPlayer.create(question2.this, R.raw.wrong);
                        mp.start();
                        TastyToast.makeText(question2.this, "wrong", TastyToast.LENGTH_LONG, TastyToast.ERROR).show();
                    }
                }
                else
                {
    ...
    public void onBackPressed() {
        ...
        ap.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent i=new Intent(question2.this, homescreen.class);
