...
public class question3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question=getIntent().getExtras().getString("ques3");
        ...
        verify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!tv1.getText().toString().equals("") && !tv2.getText().toString().equals("") && !tv1.getText().toString().equals("Small Text") && !tv2.getText().toString().equals("Small Text")) {
                    ...
                    df = lt.ansloca(dd, ds, lat3, lot3);
                    Toast.makeText(getApplication(), "" + df, Toast.LENGTH_LONG).show();
                    if (df <= 20) {
                        MediaPlayer mp = MediaPlayer.create(question3.this, R.raw.correct);
                        mp.start();

                        TastyToast.makeText(question3.this, "correct", TastyToast.LENGTH_LONG, TastyToast.SUCCESS).show();
                        ...
                        MediaPlayer mp = MediaPlayer.create(question3.this, R.raw.wrong);
                        mp.start();
                        TastyToast.makeText(question3.this, "wrong", TastyToast.LENGTH_LONG, TastyToast.ERROR).show();
                    }
                }
                else
                {
    ...
    public void onBackPressed() {
        ...
        ap.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent i=new Intent(question3.this, homescreen.class);
